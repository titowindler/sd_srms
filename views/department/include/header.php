 ...
 <nav class="navbar navbar-expand navbar-primary bg-primary static-top">
     ...
     <ul class="navbar-nav ml-auto ml-md-0">
      ...
      <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color:white;margin-right:-15px;font-size:15px">
            <!-- <i class="fa fa-user-circle fa-fw" style="font-size:20px;margin-right:10px"></i> --><?php echo $_SESSION["department_personnel_name"];?>
        </a>
      </li>
