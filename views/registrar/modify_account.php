...
<?php include('include/header.php');?>
  <div id="wrapper">
    ...
    <div class="mt-3">
        <h3 class="text-dark">View All Students</h3>
          <hr class="bg-info">
    </div>
              ...
              while ($row=mysqli_fetch_array($result)) {
                ?> 
                 ...
                 <tr>
                  ...
                  <td>BS-IT 3rd Year</td>
                  <td><a href="view_student_account.php?view=<?php echo $row['student_id']?>" class="btn btn-primary">VIEW</a></td>
                </tr> 
