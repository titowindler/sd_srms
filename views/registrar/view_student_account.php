...
<body id="page-top">
  ...
  <div id="wrapper">
     ...
     <?php include('include/sidebar.php');
      ...
      $sqlFetch = "SELECT * FROM student WHERE student_id = '$student_id' ";
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      <div class="card-header bg-primary" style="color:white;border-bottom: white"><h3><center><?php echo $student_fname?> <?php echo $student_lname?></center></h3>
      </div>
