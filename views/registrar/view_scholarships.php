...
<?php include('include/header.php');?>
  <div id="wrapper">
    ...
    <div class="mt-3">
        <h3 class="text-dark">View Scholarships</h3>
      ...
      <thead>
           ...
           <?php
               $conn = connect();
               $result=mysqli_query($conn,"SELECT * FROM merit ");
              while ($row=mysqli_fetch_array($result)) {
                ?> 
            
                 <tr>
                  <td><?php echo $row['merit_desc'];?></td>
                  <td><?php echo $row['merit_type'];?></td>
                  <td><?php echo $row['merit_discount'];?>%</td>
                </tr> 
